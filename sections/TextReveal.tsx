  ...
  return (
    <section className="min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 text-left items-center  border h-160 lg:gap-12">
        ...
        {/* RIGHT: Text */}
        <div className="space-y-6 text-left lg:text-left order-1 lg:order-2">
      ...
      <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 text-left items-center  h-160 lg:gap-12">
        ...
        <div className="space-y-6 text-left lg:text-left">
          ...
          <div className="relative">
            ...
            <p className="absolute inset-0 text-white text-sm sm:text-base md:text-[1.5rem] leading-relaxed whitespace-nowrap">
              <span className="fill-span-1 block overflow-hidden w-0 whitespace-nowrap">
                With a bold clock, encouraging quote, and personalized{" "}
              </span>
              <span className="fill-span-1 block overflow-hidden w-0 whitespace-nowrap">
                greetings that evolve with your day, the Home{" "}
     ...
     <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 text-left items-center  border h-160 lg:gap-12">
        ...
        <div className="space-y-6 text-left lg:text-left order-1 lg:order-2">
          ...
          <div className="relative">
            ...
            <p className="absolute inset-0 text-white text-sm sm:text-base md:text-[1.5rem] leading-relaxed whitespace-nowrap">
              <span className="fill-span_2 block overflow-hidden w-0 whitespace-nowrap">
                With a bold clock, encouraging quote, and personalized{" "}
              </span>
              <span className="fill-span_2 block overflow-hidden w-0 whitespace-nowrap">
                greetings that evolve with your day, the Home{" "}
